...
ALTER TABLE "users" ADD COLUMN "displayUsername" text;--> statement-breakpoint
...
ALTER TABLE "users" ADD CONSTRAINT "users_displayUsername_unique" UNIQUE("displayUsername");